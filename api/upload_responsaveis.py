...
def upload_responsaveis():
	...
	try:
		...
		_history('responsaveis', filename, True, message, count, usuario)
		return jsonify({'sucesso': True, 'mensagem': f'Concluído! {message}', 'registros': count})
	except Exception as error:
		_history('responsaveis', arquivo.filename if arquivo else '', False, str(error), usuario=usuario)
...
if __name__ == '__main__':
	...
	print("   POST /api/upload_responsaveis")
